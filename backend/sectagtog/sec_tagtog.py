...
class SECTagTog:
    ...
    def mostRecent(self, form_type, company_tick):
        ...
        os.rename(
            self.dir + "/filing-details.html",
            self.dir + "/" + company_tick + "_" + form_type + ".html",
        )

        # Adds to the TagTog Project
        self.tagtog.import_by_html(
            "TestProject", self.dir + "/" + company_tick + "_" + form_type + ".html"
        )
...
def main():
    test_api = SECTagTog(
        "ryanmurf9",
        "testapipassword123",
        "/home/ryanmurf9/Documents/Senior Project/Fraxure/backend/sec-tagtog/file_system",
        "TestProject",
    )
